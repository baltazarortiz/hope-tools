...
LIBREFPIPE				 := $(BSP_BASE)/librefpipe.a
LIBISP           := $(ISP_RUNTIME)/libisp.a

ISP_LIBS         := $(LIBISP) $(LIBREFPIPE)

ISP_LDFLAGS			 := -T $(BSP_BASE)/link.ld -nostartfiles -defsym=_STACK_SIZE=4K -fuse-ld=lld
ISP_LDFLAGS			 += -Wl,--wrap=isatty

#ISP_LDFLAGS			 := -T /home/ubuntu/testnew/chipyard-ref-pipe/toolchains/libgloss/util/htif.ld
#ISP_LDFLAGS += -L $(abspath .)
#ISP_LDFLAGS += -L /home/ubuntu/testnew/chipyard-ref-pipe/toolchains/libgloss/build
#ISP_LDFLAGS += -specs=/home/ubuntu/testnew/chipyard-ref-pipe/toolchains/libgloss/util/htif_nano.specs
#ISP_LDFLAGS			 += -nostartfiles -defsym=_STACK_SIZE=4K #-fuse-ld=lld
#ISP_LDFLAGS			 += -Wl,--wrap=isatty
#ISP_LDFLAGS += -L /home/ubuntu/testnew/chipyard-ref-pipe/toolchains/libgloss/build
...
#RISCV := /home/ubuntu/testnew/chipyard-ref-pipe/riscv-tools-install
#PATH := $(RISCV)/bin:$(PATH)
#LD_LIBRARY_PATH := $(RISCV)/lib$(LD_LIBRARY_PATH:+:$(LD_LIBRARY_PATH))
